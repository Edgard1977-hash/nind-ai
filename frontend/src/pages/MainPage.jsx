    ...
    <div className="main-page" data-testid="main-page">
      ...
      <div className="perspective-grid">
        <svg viewBox="0 0 400 300" preserveAspectRatio="none" className="grid-svg">
          ...
          <path d="M0,50 Q200,50 400,50" stroke="rgba(255,255,255,0.06)" strokeWidth="1" fill="none"/>
          <path d="M0,100 Q200,95 400,100" stroke="rgba(255,255,255,0.07)" strokeWidth="1" fill="none"/>
          <path d="M0,150 Q200,140 400,150" stroke="rgba(255,255,255,0.08)" strokeWidth="1" fill="none"/>
          <path d="M0,200 Q200,180 400,200" stroke="rgba(255,255,255,0.09)" strokeWidth="1" fill="none"/>
          <path d="M0,250 Q200,220 400,250" stroke="rgba(255,255,255,0.1)" strokeWidth="1" fill="none"/>
