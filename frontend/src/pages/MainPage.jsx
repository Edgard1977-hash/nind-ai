...
// Star icon SVG (for Start button)
const StarStartIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" className={className} fill="currentColor">
    <path d="M 128.28 545.75 C127.14,544.51 122.58,532.96 118.15,520.07 C113.72,507.19 109.28,495.84 108.30,494.85 C107.31,493.86 96.71,489.68 84.74,485.55 C72.77,481.42 61.62,477.34 59.95,476.47 C56.18,474.52 53.48,469.20 54.41,465.52 C55.74,460.19 58.87,458.54 82.93,450.52 C95.76,446.25 107.00,442.00 107.92,441.08 C108.84,440.16 113.09,429.08 117.37,416.46 C125.98,391.05 127.81,388.00 134.46,388.00 C140.83,388.00 142.24,390.39 150.99,416.00 C156.27,431.44 159.73,440.09 161.09,441.23 C162.23,442.18 172.47,445.94 183.83,449.59 C207.66,457.24 211.39,458.92 213.48,462.96 C215.39,466.65 215.39,468.35 213.48,472.03 C211.47,475.93 210.03,476.59 184.54,485.36 C169.93,490.39 161.93,493.66 160.47,495.20 C159.15,496.58 155.17,506.59 150.49,520.30 C146.21,532.84 141.84,544.20 140.78,545.55 C138.14,548.91 131.29,549.02 128.28,545.75 ZM 287.88 542.21 C277.81,536.95 277.59,536.49 259.48,483.50 C238.94,423.40 228.81,394.58 226.97,391.00 C225.09,387.32 221.27,383.38 216.89,380.61 C215.46,379.70 199.26,373.76 180.89,367.40 C162.53,361.04 135.35,351.64 120.50,346.51 C83.26,333.63 82.90,333.50 78.45,331.23 C62.65,323.14 55.59,305.53 62.50,291.41 C65.59,285.10 73.07,278.06 80.35,274.62 C83.22,273.25 114.81,262.44 150.54,250.59 C192.11,236.79 216.79,228.11 219.09,226.47 C221.07,225.06 223.67,222.16 224.86,220.03 C226.06,217.90 236.90,186.85 248.95,151.05 C260.99,115.24 271.81,83.96 272.99,81.53 C275.60,76.13 281.72,69.85 286.76,67.40 C291.49,65.10 303.51,64.36 308.67,66.04 C314.24,67.86 320.69,72.58 323.60,76.97 C327.04,82.17 329.63,89.41 352.50,157.83 C366.36,199.31 373.18,218.33 375.16,221.06 C378.61,225.82 383.72,228.44 400.00,233.78 C406.88,236.04 435.45,245.39 463.50,254.57 C491.55,263.75 517.13,272.58 520.33,274.19 C547.11,287.61 547.14,317.90 520.40,331.32 C517.59,332.73 498.69,339.59 478.40,346.55 C402.82,372.50 384.44,379.12 380.70,381.70 C373.63,386.61 374.29,384.94 344.06,473.50 C334.67,501.00 325.67,526.20 324.05,529.51 C318.74,540.37 311.66,545.00 300.38,545.00 C294.49,545.00 292.28,544.51 287.88,542.21 Z"/>
  </svg>
);
                    ...
                    {isLoadingVideos ? (
                      ...
                      <div className="creations-empty-pattern">
                        ...
                        <div className="creations-empty-overlay">
                          ...
                          >
                            <StarStartIcon className="start-btn-icon" />
                            {t('start')}
                          </button>
                        </div>
                      </div>
