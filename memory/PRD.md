...
- ✅ **Монтаж интегрирован в /create** — Больше нет отдельной страницы монтажа:
  - Загружаешь видео на странице создания
  - Пишешь промт (напр: "динамичный монтаж с мемами для TikTok")
  - AI автоматически определяет стиль по промту
  - Результат с кнопками "Скачать" и "Создать ещё"
- ✅ **Chunked Upload** — Большие файлы загружаются частями по 2MB
- ✅ **File Upload Bug Fixed** — Расширена валидация типов файлов
